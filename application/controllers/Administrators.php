...
class Administrators extends CI_Controller
{
  ...
  public function laad_()
  {
    ...
    $administrators = $this->admin->getAll();

if (is_array($administrators) || $administrators instanceof Countable) {
    $totalAdministrators = count($administrators);
} else {
    $totalAdministrators = 0; // or handle it according to your logic
}
