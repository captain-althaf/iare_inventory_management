...
if(is_cli()){
    ...
    // $config['base_url'] =  $protocol . $host;
     $config['base_url'] =  $protocol.$host."/iare_inventory_management/";
}

else{
    $allowed = ['www.1410inc.xyz', '1410inc.xyz'];//input all allowed urls here e.g. amirsanni.com, www.practa.ng, smartagapp.com

    $config['base_url'] = in_array($host, $allowed) ? $protocol.$host."/iare_inventory_management/" : "http://".$_SERVER['HTTP_HOST']."/";
}
